...
const PriorityQueue = require("../../Complex DS/Heaps/Priority_Queue.js");
...
const resultsDijkstras = dijkstras(testGraph, testGraph.vertices[0]);
console.log(resultsDijkstras);

console.log("Shortest path between A and G:");
const A = testGraph.getVertexByValue("A");
const G = testGraph.getVertexByValue("G");
const resultsShortestPath = shortestPathBetween(testGraph, A, G);
console.log(resultsShortestPath);
